...
![No-Deps](https://img.shields.io/badge/Dependencies-NONE-success?style=for-the-badge)
![Filesize](https://img.shields.io/badge/Footprint-~500KB-blueviolet?style=for-the-badge)
![License](https://img.shields.io/badge/License-FOSS-brightgreen?style=for-the-badge)

---

## 🛰️ WHAT IS JAC?
**JAC** is a self-contained, privacy-first "Field Intelligence" tool designed for community organizers, mutual aid workers, and residents of New Jersey. 

Imagine a cross between a **hardened digital library**, a **privacy-centric chatbot**, and a **tactical toolkit**—all living inside a single HTML file. It provides instant, offline access to deep local knowledge that distant government agencies struggle to manage, ranging from tenant rights and labor history to infrastructure data and emergency resources. For everyone who watched Blade Runner and wanted to be the person building the gear in the shadows: JAC is your black-market electric sheep order form, delivered in ~500KB of pure vanilla code.

### 🛡️ Core Capabilities:
* **Offline Knowledgebase:** 485+ built-in data packets on NJ geography, history, and law.
* **Privacy-First AI:** A chatbot interface that "riffs" on LLM logic to provide local intelligence without ever connecting to a server.
* **Tactical Utilities:** Integrated symbolic math engines, writing auditors, and data validators (ZIP, SSN, CC, Plates).
* **Built-in Resilience:** A full micro-game development kit and procedural arcade for offline downtime.
...
| Prefix | Handler Logic | Example |
| :--- | :--- | :--- |
| `tel:` | NANP Region & Country ID | `tel: 973-555-1234` |
| `math:` | Symbolic & Numerical Solver | `math: 256*3/y=512` |
| `plate:` | NJ DMV Format Validator | `plate: ABC-1234` |
| `zip:` | 722 NJ ZIPs (City/County) | `zip: 07102` |
